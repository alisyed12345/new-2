...
<div class="page-header page-header-default">
  ...
  <div class="breadcrumb-line">
    <ul class="breadcrumb">
      ...
      <li class="active">Add Class Time</li>
    </ul>
  </div>
</div>
<!-- /page header --> 
  ...
  <form id="frmICK" name="frmICK" class="form-validate-jquery" method="post">
    <div class="panel panel-flat">
      ...
      <div class="ajaxMsg"></div>
        ...
        <br>
        <div class="row">
          <div class="col-md-1" style="margin-top:30px;">Time</div>
          
          <div class="col-md-2 col-xs-6">
            <label for="sun_from">Start Time </label> 
          ...
          <label for="sun_to">End Time <span class="mandatory">*</span></label> 
            <select class="form-control endtime"  data-pairSlot="sun_from" name="sun_to" id="sun_to" greaterThan="true" onchange="childdiv()">
