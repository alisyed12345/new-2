...
$mob_title = "Edit Page";
include "../header.php";
$page = $db->get_row("select * from ss_page where id='" . $_GET['id'] . "'");
//AUTHARISATION CHECK 
if (!in_array("su_pages_edit", $_SESSION['login_user_permissions'])) {
...
<div class="page-header page-header-default">
  ...
  <div class="breadcrumb-line">
    <ul class="breadcrumb">
      ...
      <li><a href="<?php echo SITEURL . "page/page_list" ?>">Pages List</a></li>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input placeholder="Page Name" required name="page_name" id="page_name" value="<?php echo $page->page_name ?>" required class="form-control" type="text">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label>Status:</label>
                  <select name="active" id="active" required class="select form-control">
                    <option value="">Select</option>
                    <option value="1" <?php echo $page->active == 1 ? 'selected="selected"' : '' ?>>Active</option>
                    <option value="0" <?php echo $page->active == 0 ? 'selected="selected"' : '' ?>>Inactive</option>
                  </select>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea id="contents" name="contents" placeholder="Contents" required class="form-control" ><?php echo $page->contents ?></textarea>
                </div>
              </div>
            </div>
            <div class="row">
