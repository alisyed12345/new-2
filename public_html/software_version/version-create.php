<?php 
$mob_title = "Software Version Create";
include "../header.php";
...
<div class="page-header page-header-default">
    ...
    <?php if (!empty($current_session->id) && !empty($get_info->school_name) && !empty($get_info->center_short_name) && !empty($get_info->new_registration_session) && !empty($version->major)) { ?>
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            <li><a href="<?php echo SITEURL ?>dashboard"><i class="icon-home2 position-left"></i> Dashboard</a></li>
            <li><a href="<?php echo SITEURL ?>software_version/version-list">List Software Versions</a></li>
            <li class="active">Add New Software Version </li>
        </ul>
    </div>
    <?php }else{ ?>
  <div class="breadcrumb-line">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <label class="form-check-label" for="radio1">
                                            <input type="radio" class="form-check-input required" id="radio1" name="notification" value="1"> Yes
                                        </label>
                                        </div>
                                        </div>
                                        <div class="col-md-2">
                                        ...
                                        <label class="form-check-label" for="radio2">
                                            <input type="radio" class="form-check-input required" id="radio2" name="notification" value="0"> No
                                        </label>
                                        </div>
                                        </div>
                                    </div>
                          ...
                          <div class="row">
                              <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control required"  id="patch" name="patch" maxlength="8" placeholder="Enter Patch">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control"  id="describtion" name="describtion" placeholder="Enter Describtion"  style="height:200px"></textarea>
                                </div>
                            </div>
                        </div>
