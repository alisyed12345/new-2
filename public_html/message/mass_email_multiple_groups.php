...
$mob_title = "Mass Email Multiple Group";
include "../header.php";
...
<div class="page-header page-header-default">
  <div class="page-header-content">
    <div class="page-title">
      <h4>Mass Email New Design</h4>
    </div>
  </div>
  <div class="breadcrumb-line">
    <ul class="breadcrumb">
      <li><a href="<?php echo SITEURL . "dashboard" ?>"><i class="icon-home2 position-left"></i> Dashboard</a></li>
      <li class="active">Mass Email New Design</li>
    </ul>
  </div>
</div>
<!-- /page header -->
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <select class="bootstrap-select " data-width="100%" id="grouprr" name="group"   required>
          ...
          <div class="col-md-4">
            <div class="form-group">
                ...
                <select class="form-control" name="class" id="classesrr" required>
               <option value="">Select Subject</option><option value="all_subjects">All Subjects</option><option value="8">Arabic</option><option value="9">Quran</option><option value="10">Islamic Studies</option>                        
                </select>
            </div>
        </div>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <select class="bootstrap-select" data-width="100%" id="studentss" name="student" required>
                <option value="">Select</option>
                <option value="0">All Students</option>
                <option value="1">Nasir mirza</option>
                <option value="2">Rafat Salman</option>
              </select>
            </div>
          </div>
        </div>
         <div id ="formultiple" style="display: none;" >
          <div class="col-md-4">
              <div class="form-group">
                <label>Group</label>
                <?php $groups = $db->get_results("SELECT * from ss_groups where session = '".$_SESSION['icksumm_uat_CURRENT_SESSION']."' AND is_active = 1 and is_deleted = 0 order by group_name asc"); ?>
                <select class="bootstrap-select " data-width="100%" id="group" name="group[]"  multiple="true" required>
                  <option value="">Select</option>
                  <option value="all_groups">All Groups</option>
                  <?php foreach ($groups as $gr) { ?>
                  <option value="<?php echo $gr->id ?>"><?php echo $gr->group_name ?></option>
          ...
          <div class="col-md-4">
              <div class="form-group">
                  <label for="group">Subject</label>
                  <select class="bootstrap-select" data-width="100%" name="class[]" id="classes" multiple="true" required>
          ...
          <div class="col-md-4">
            <div class="form-group">
              <label>Parents Of</label>
              <select class="bootstrap-select" data-width="100%" id="student" name="student" multiple="true" required>
                <option value="">Select</option>
               <!--  <option value="0">All Students</option> -->
...
/*    $('#group').change(function() {
    ...
    $('#frmICK').submit(function(e) {
      ...
      // } 
      // else {
      //   var validator = $('#frmICK').valid();
      //   var errors = validator.errorList();
      //   alert("not valid"+errors);
      //   return false;
      // }
    });
  });
