...
--
-- Table structure for table `ss_payment_sch_item_cron`
--

CREATE TABLE `ss_payment_sch_item_cron` (
...
--
-- Indexes for table `ss_payment_sch_item_cron`
--
ALTER TABLE `ss_payment_sch_item_cron`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `ss_payment_sch_item_cron`
--
ALTER TABLE `ss_payment_sch_item_cron`
